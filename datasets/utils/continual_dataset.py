...
class ContinualDataset:
    ...
    @abstractmethod
    def get_data_loaders(self, base_data_path: str) -> Tuple[DataLoader, DataLoader]:
        """
    ...
    @abstractmethod
    def not_aug_dataloader(self, batch_size: int, base_data_path: str) -> DataLoader:
        """
    ...
    @abstractmethod
    def second_pass_dataloader(self, batch_size: int, base_data_path: str) -> DataLoader:
        """
        Returns the dataloader of the current task,
        not applying data augmentation.
        :param batch_size: the batch size of the loader
